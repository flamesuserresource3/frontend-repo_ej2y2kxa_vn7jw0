...
export default function Hero3D() {
  return (
    <section id="top" className="relative w-full bg-gradient-to-b from-pink-50 via-white to-white">
      {/* Give the scene a fixed viewport height so the canvas never collapses */}
      ...
      {/* Foreground copy sits on top without using negative z-index */}
      <div className="pointer-events-none absolute inset-x-0 top-0 flex h-[100svh] items-center">
        <div className="pointer-events-auto relative z-10 mx-auto w-full max-w-6xl px-4">
